...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active">
                <a class="nav-link box" href="ueberMich.php">Über&nbsp;Mich<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
  ...
  <!-- <div class="w3-display-container w3-container">
    ...
    <div class="w3-display-topleft w3-text-white" style="padding:24px 48px">
      <h1 class="w3-jumbo w3-hide-small">First and Second Hand</h1>
      <h1 class="w3-hide-large w3-hide-medium">First and Second Hand</h1>
      <h1 class="w3-hide-small">and More</h1>
        ...
        <article class="ersterartikel artikel">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p class="lead">Seit Über 20 Jahren bin ich auf Deutschlands qualitativ hochwertigen Märkten in
